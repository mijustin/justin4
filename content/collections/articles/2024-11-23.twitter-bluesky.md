...
article_content:
  ...
  -
    ...
    attrs:
      ...
      values:
        type: sidebar
        text: "But I've decided to delete all my posts, lock down my account, and leave the platform. Instead, [I'm going all-in on Bluesky](https://go.bsky.app/9Xi4xtt), which (in the last month) has become 1,000x better than X."
  -
    type: heading
    attrs:
      level: 2
