...
article_content:
  -
    ...
    content:
      -
        type: text
        text: "AI coding tools like Cursor and Claude Code have completely consumed the tech industry's attention. Many believe that we're hurdling towards a future where normal people build their own software, obviating the entire SaaS market."
  -
    type: set
    attrs:
      id: mbpbz2d1
