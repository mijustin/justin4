...
article_content:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Apple could feature creator-made video podcasts as a new content category in the Apple TV ecosystem. '
  -
    type: paragraph
    content:
      -
        type: text
        text: 'I think a dedicated "Apple Video Podcasts" app on the Apple TV'
  -
    type: paragraph
    content:
      -
        type: text
        text: 'This would give independent creators a path to reach TV screens without surrendering their independence to YouTube.'
  -
    type: paragraph
    content:
      -
        type: text
        text: 'This echoes what James Cridland pointed out on'
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: " about Netflix's interest in video podcasts: \"What's a video podcast? It's a cheap TV show.\" The difference is that while Netflix wants cheap TV content to keep viewers within their ecosystem, Apple could create a more creator-friendly approach that preserves the open RSS standard while still offering monetization through"
      -
        type: text
        marks:
          -
            type: link
            attrs:
              href: 'https://podcasters.apple.com/878-subscriptions'
              rel: null
              target: null
              title: null
        text: " Apple's paid podcast subscriptions"
      -
        type: text
        text: .
  -
    ...
    content:
      -
        type: text
        text: 'By creating this alternative distribution path for video podcasts, Apple could position itself as the creator-friendly alternative to YouTube – a place where podcasters can distribute video content without surrendering their independence to a closed platform.'
custom_structured_data:
  code: null
  mode: htmlmixed
updated_by: 0cf68b9f-296d-4280-83ba-2fcfa61746b1
updated_at: 1746750538
---
