...
article_content:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Apple could feature video podcasts as a new category/app within the Apple TV ecosystem. '
  -
    type: set
    attrs:
      id: mag2uqaz
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Watching video podcasts on Apple TV right now is technically possible, but it''s really difficult to find them. "Video podcasts" should be a separate app in the UI.'
  -
    type: paragraph
    content:
      -
      ...
      -
        type: text
        text: " that a \"video podcast is a cheap TV show.\" This is one reason why Netflix has\_"
      -
        type: text
        marks:
          -
      ...
      -
        type: text
        text: ' – it''s a "cheap" way to keep viewers in its ecosystem. Apple could create a more creator-friendly approach that preserves the open RSS standard while still offering monetization through'
      -
        type: text
        marks:
          -
        ...
        marks:
          -
            ...
            attrs:
              ...
              target: null
              title: null
        text: ' paid podcast subscriptions'
      -
        type: text
        text: .
  -
    ...
    content:
      -
        type: text
        text: 'By creating this alternative distribution path for video podcasts, Apple could position itself as the creator-friendly alternative to YouTube.'
