...
article_content:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Today, we are proudly "B2Many," and serve over 33,000 users. Of those users, 40% use a personal email address (Gmail, Proton, Hotmail, Yahoo), which indicates that a large portion of our user base is "consumer/prosumer."'
  -
    type: paragraph
    content:
      -
