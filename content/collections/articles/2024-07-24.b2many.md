...
article_content:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'For example, products like Canva, MailChimp, Carrd, Transistor, Fathom Analytics, Trello, Slack, Notion, and Tailwind UI are used by a wide variety of users.'
  -
    type: set
    attrs:
      id: lz0iehaw
  ...
  -
    ...
    content:
      -
        type: text
        text: 'Today, we are proudly "B2Many," and serve over 25,000 users and 7,000+ paying accounts. Also, none of the scary stories we heard about serving consumers, creators, and prosumers turned out to be true:'
  -
    type: bulletList
    content:
      -
