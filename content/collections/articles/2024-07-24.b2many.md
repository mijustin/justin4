...
article_content:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'First, "B2B" is too vague to be useful as a category. If "B2B" describes any business that targets other businesses, it lumps together businesses that sell to creators, prosumers, and solopreneurs with businesses that sell to Fortune 500 companies and large government agencies.'
  -
    type: paragraph
    content:
      -
        type: text
        text: 'If B2B businesses include YouTube influencers, people selling online courses, solopreIt spans a spectrum: from solopreneurs to Fortune 500 companies, from local non-profits to government agencies. Each of these has unique needs, budgets, and buying processes.'
  -
    type: paragraph
    content:
      -
