...
article_content:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'The rationale for differentiating B2C/B2B is that these categories have markedly different characteristics and require different approaches to reach them. However, when you ask someone to define "B2C," most attributes also fit B2Prosumer + B2SMB (especially in SaaS).'
  -
    type: set
    attrs:
      id: lz1v99s6
