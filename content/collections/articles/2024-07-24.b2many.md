...
article_content:
  ...
  -
    ...
    content:
      -
        type: text
        text: "And we're not the only bootstrapped company employing the B2M approach! MailChimp, Carrd, Fathom Analytics, Laravel Forge, and Tailwind UI all serve a spectrum of customer types (consumers, small businesses, and enterprises)."
  -
    type: heading
    attrs:
      level: 2
