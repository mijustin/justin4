...
article_content:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'The truth was our customers (whether they were hobbyists, prosumers, or businesses building a brand) were all looking for the same thing: an easy way to upload, publish, and distribute their podcasts to Apple Podcasts, Spotify, YouTube, etc.'
  -
    type: blockquote
    content:
      -
        ...
        content:
          -
            type: text
            text: 'The truth is that consumers, freelancers, and creators often want the same things as SMBs, enterprise teams, and government agencies: well-made software that gets the primary job done well.'
  -
    type: paragraph
    content:
      -
